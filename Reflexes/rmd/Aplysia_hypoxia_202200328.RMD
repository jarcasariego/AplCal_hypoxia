...
ggsave("figures/DO_Temp_daily_average_plots.png", p3, width = 5, height = 3)
...
p2 <- ggplot(weight2, aes(x = treatment, y = rate, fill=batch)) +
  geom_boxplot() +
  scale_fill_discrete(labels = c("lab-reared parents", "wild parents")) +
  scale_fill_brewer(palette="Greys") + 
  labs(x=NULL, y = "Growth rate") +
  theme_classic()

ggsave("figures/growth_rate.png", p2, width = 3, height = 3)
...
adonis(rate~treatment, data = weight2[which(weight2$batch == 60),], method = "euclidean")
adonis(rate~treatment*batch, data = weight2, method = "euclidean")
...
ggsave("figures/reflex_plot_batch60.png", plot = grid.arrange(p1, p2, p3, ncol=3), width = 12, height = 3)

ggsave("figures/reflex_plot_batch70.png", plot = grid.arrange(p4, p5, p6, ncol=3), width = 12, height = 3)
```
...
# PERMANOVA analyses 
# General differences
adonis(TTR~treatment*sample*batch, data = TTR, method = "euclidean")
adonis(TTR~treatment*sample, data = TTR, strata = TTR$batch, method = "euclidean")

#Per batch
TTR60 <- TTR[which(TTR$batch==60),]
TTR71 <- TTR[which(TTR$batch==71),]
adonis(TTR~treatment*sample, data = TTR60, method = "euclidean")
adonis(TTR~treatment*sample, data = TTR71, method = "euclidean")

# Per batch and sample date
adonis(TTR~treatment, data = TTR60[which(TTR60$sample=="Day 2"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR60[which(TTR60$sample=="Day 3"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR60[which(TTR60$sample=="Day 4"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR60[which(TTR60$sample=="Day 5"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR60[which(TTR60$sample=="Day 6"),], na.rm =T, method = "euclidean")

adonis(TTR~treatment, data = TTR71[which(TTR71$sample=="Day 2"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR71[which(TTR71$sample=="Day 3"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR71[which(TTR71$sample=="Day 4"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR71[which(TTR71$sample=="Day 5"),], na.rm =T, method = "euclidean")
adonis(TTR~treatment, data = TTR71[which(TTR71$sample=="Day 6"),], na.rm =T, method = "euclidean")

# TWR general
adonis(duration~treatment*sample, data = TWR, method = "euclidean")
adonis(duration~treatment*sample*batch, data = TWR, method = "euclidean")
adonis(duration~treatment*sample, data = TWR, strata = TWR$batch, method = "euclidean")
adonis(duration~treatment*sample*batch, data = TWR, strata = TWR$sample, method = "euclidean")

adonis(contraction~treatment*sample, data = TWR, method = "euclidean")
adonis(contraction~treatment*sample*batch, data = TWR, method = "euclidean")
adonis(contraction~treatment*sample, data = TWR, strata = TWR$batch, method = "euclidean")
adonis(contraction~treatment*sample*batch, data = TWR, strata = TWR$sample, method = "euclidean")

#Per batch
TWR60 <- TWR[which(TTR$batch==60),]
TWR71 <- TWR[which(TTR$batch==71),]
adonis(duration~treatment*sample, data = TWR60, method = "euclidean")
adonis(duration~treatment*sample, data = TWR71, method = "euclidean")
adonis(contraction~treatment*sample, data = TWR60, method = "euclidean")
adonis(contraction~treatment*sample, data = TWR71, method = "euclidean")

adonis(duration~treatment, data = TWR60[which(TWR60$sample=="Day 2"),], method = "euclidean")
adonis(duration~treatment, data = TWR60[which(TWR60$sample=="Day 3"),], method = "euclidean")
adonis(duration~treatment, data = TWR60[which(TWR60$sample=="Day 4"),], method = "euclidean")
adonis(duration~treatment, data = TWR60[which(TWR60$sample=="Day 5"),], method = "euclidean")
adonis(duration~treatment, data = TWR60[which(TWR60$sample=="Day 6"),], method = "euclidean")

adonis(contraction~treatment, data = TWR60[which(TWR60$sample=="Day 2"),], method = "euclidean")
adonis(contraction~treatment, data = TWR60[which(TWR60$sample=="Day 3"),], method = "euclidean")
adonis(contraction~treatment, data = TWR60[which(TWR60$sample=="Day 4"),], method = "euclidean")
adonis(contraction~treatment, data = TWR60[which(TWR60$sample=="Day 5"),], method = "euclidean")
adonis(contraction~treatment, data = TWR60[which(TWR60$sample=="Day 6"),], method = "euclidean")
