...
setwd("~/FIU/3 Summer 2019/MEGA Workshop/GO_MWU-master")

#Make sure you move the files into the working directory where the GO MWU is 

## goAnnotations- you give Eggnog your transcriptome and they annotate it for you, unless there is already annotated transcriptome for your species. Species specific, not study-specific

# Edit these to match your data file names: 
input="darkolivegreen.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
...
goDivision="CC" # either MF, or BP, or CC #BP takes a long time (hours)
...
results=gomwuPlot(input,goAnnotations,goDivision,
	#absValue=-log(0.05,10),  # genes with the measure value exceeding this will be counted as "good genes". Specify 
	absValue=0.001, # if you are doing Fisher's exact test for standard GO enrichment or analyzing a WGCNA module (all non-zero genes = "good genes").
	#absValue=1,
...
#52% of genes as "good genes" are included for MF
#if you redcuce cutoffs by factor of 10, only 31%
