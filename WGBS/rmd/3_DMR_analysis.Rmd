...
save(all_DMR_100bp, perc_meth_100, meta, Naive_perc_meth_100, pre_exposed_perc_meth_100, file = "output/DMR_data.RData")
```
...
ggsave(filename = "figures/Fig_pcoa_DMR_preexposed.png",pcoa, width = 109, height = 84.5, units = "mm")
...
ggsave(filename = "figures/DAPC_DMR_naive.png", plot = dapc.fig, width = 109, height = 84.5, units = "mm")
