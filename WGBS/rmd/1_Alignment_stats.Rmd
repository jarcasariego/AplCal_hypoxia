...
multi_bismark <- fread("data/Alignment_QC/multiqc_data/multiqc_bismark_alignment.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
multi_dedup <- fread("data/Alignment_QC/multiqc_data/multiqc_bismark_dedup.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
#general trimming stats
raw_multiqc <- fread("data/Alignment_QC/multiqc_data/multiqc_raw_general_stats.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
trim_multiqc <- fread("data/Alignment_QC/multiqc_data/multiqc_trimming_stats.txt", header = TRUE, sep = "\t", stringsAsFactors = FALSE)
#load metadata
meta <- readxl::read_xlsx("data/Alignment_QC/Sample_Metadata.xlsx", sheet = "SampleNormalization_AllAnalyses")
...
cov_dist <- read.csv("data/Alignment_QC/CpGbyCoverage.csv", header = TRUE, sep = ",")
...
jpeg("figures/AplCal_WGBS_mappingStat.jpg", width = 8, height= 3.5, units = "in", res = 300 )
...
jpeg("output/ACER_CpGxCov_WGBS.jpg", width = 4.5, height = 3, units = "in", res = 300)
